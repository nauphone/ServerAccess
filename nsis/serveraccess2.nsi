...
LangString TEXT_DesktopShortcut             ${LANG_RUSSIAN} "����� �� ������� ����"
...
LangString TEXT_IncorrectJavaVersion        ${LANG_RUSSIAN} "��� ������� ���������� ��������� Java ������ �� ���� ${JAVA_MAJOR_VERSION}.${JAVA_MINOR_VERSION}.$\n���������� ���������?"
...
LangString TEXT_EnableBasicAuthorization    ${LANG_RUSSIAN} "�������� ��������� Basic Authorization ��� IEv6+"

LangString TEXT_InstallDefaultPuttyCodepage    ${LANG_ENGLISH} "Install default codepage for putty to UTF-8"
LangString TEXT_InstallDefaultPuttyCodepage    ${LANG_RUSSIAN} "���������� ��� putty ��������� UTF-8"
